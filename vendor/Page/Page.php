...
class Page
{
    ...
    private function pageList()
    {
        ...
        $_pageList .= ' <li class="page-item active"><a class="page-link" >' . $this->page . '</a></li> ';
    ...
    private function first()
    {
        if ($this->page == $this->bothNum + 2) {
            return '<li class="page-item"><a class="page-link" href="' . $this->url . '">1</a></li>';
        } elseif ($this->page > $this->bothNum + 2) {
            return '<li class="page-item"><a class="page-link" href="' . $this->url . '">1</a></li><li class="disabled page-item"><span class="page-link">...</span></li>';
        }
    }
    ...
    private function last()
    {
        if ($this->pageNum - $this->page == $this->bothNum + 1) {
            return '<li class="page-item"><a class="page-link" href="' . $this->url . 'page=' . $this->pageNum . '">' . $this->pageNum . '</a></li>';
        } elseif ($this->pageNum - $this->page > $this->bothNum + 1) {
            return '<li class="disabled page-item"><span class="page-link">...</span></li><li class="page-item"><a class="page-link" href="' . $this->url . 'page=' . $this->pageNum . '">' . $this->pageNum . '</a></li>';
        }
    }
